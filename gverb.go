...
func (gv GVerb) Rate(rate int8) Input {
	...
	(&gv).defaults()
	return NewUgenInput("GVerb", rate, 0, 2, gv.In, gv.RoomSize, gv.RevTime, gv.Damping, gv.InputBW, gv.Spread, gv.DryLevel, gv.EarlyRefLevel, gv.TailLevel, gv.MaxRoomSize)
}
