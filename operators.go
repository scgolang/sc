...
func binOpExcess(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpExcess, numOutputs, x, y)
}
...
func binOpHypot(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpHypot, numOutputs, x, y)
}
...
func binOpMax(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpMax, numOutputs, x, y)
}
...
func binOpPow(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpPow, numOutputs, x, y)
}
...
func binOpRing1(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpRing1, numOutputs, x, y)
}
...
func binOpRing2(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpRing2, numOutputs, x, y)
}
...
func binOpRing3(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpRing3, numOutputs, x, y)
}
...
func binOpRing4(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpRing4, numOutputs, x, y)
}
...
func binOpThresh(rate int8, x, y Input, numOutputs int) Input {
	return newBinOpUgen(rate, BinOpThresh, numOutputs, x, y)
}
...
func unaryOpBilinrand(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpBilinrand, numOutputs, in)
}

// unaryOpCeil computes the ceiling of a signal.
func unaryOpCeil(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpCeil, numOutputs, in)
}
...
func unaryOpMidicps(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpMidicps, numOutputs, in)
}
...
func unaryOpRand(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpRand, numOutputs, in)
}
...
func unaryOpRand2(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpRand2, numOutputs, in)
}
...
func unaryOpRatiomidi(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpRatiomidi, numOutputs, in)
}
...
func unaryOpReciprocal(rate int8, in Input, numOutputs int) Input {
	CheckRate(rate)
	return NewUgenInput(UnaryOpUgenName, rate, UnaryOpReciprocal, numOutputs, in)
}
